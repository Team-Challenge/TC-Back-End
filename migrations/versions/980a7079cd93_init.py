...
def upgrade():
    ...
    op.create_table('products',
                    ...
                    sa.Column('sub_category_name',
                              sa.Enum('заколки', 'обручі', 'резинки', 'хустинки', 'сережки', 'моносережки', 'згарди',
                                      'шелести', 'гердани', 'силянки', 'кризи', 'чокери', 'намиста', 'дукачі',
                                      'кулони та підвіски', 'браслети', 'каблучки', 'котильйони', 'брошки', 'сумки',
    ...
    op.create_table('product_details',
                    ...
                    sa.Column('product_status',
                              sa.Enum('В наявності', 'Під замовлення', 'В єдиному екземплярі', 'Немає в наявності',
                                      name='product_status'), nullable=True),
